...
<div class="body"> 
	<div class="page-outer contact-page">
		...
		<div id="contact-left">
			...
			<img src="img/contact/nz.png">	
		</div> 
		<div id="contact-right">
			<h2>Account Managers</h2> 
			<ul>
				<li>Dave - dave@montage.co.nz</li> 
				<li>Derek - derek@montagenz.co.nz</li>
				<li>Nynke - nynke@montagenz.co.nz</li>
				<li>Matt - matt@montagenz.co.nz</li>
			</ul> 
			<div id="map">
			...
			<div class="showroom">Please fell free to get in touch to make a showroom <br>appointment with us</div>
		</div>
	</div>  
