<?php 
$this -> layout('master',[
	'title'=>'Montage Interiors | Our story', 
...
<div class="body story-page"> 
	<div id="sus-page" class="sus-D-grid">
		<div class="sustainability-grid">
			...
			<div class="experience top-img triangle">
				<div class="hover-over"></div>
				<img src="img/story/experience.png">
			</div> 
			<div class="journey top-img triangle">
				<div class="hover-over"></div>
				<img src="img/story/journey.png">
			</div> 
			<div>
				<div class="history bottom-img triangle">
					<div class="hover-over"></div>
	...
	<div class="sus-M-grid">
		...
		<div class="mobile-grid-sus">
			<div class="mobile-culture-art-trig">
				<h3>Culture</h3> 
				<img src="img/story/experience-mobile.png">
			</div> 
			...
			<div class="mobile-journey-art-trig">
				<h3>Journey Ahead</h3> 
				<img src="img/story/journey-mobile.png">
			</div> 
			...
			<div class="mobile-history-art-trig">
				<h3>History</h3> 
				<img src="img/story/history-mobile.png">
			</div> 
